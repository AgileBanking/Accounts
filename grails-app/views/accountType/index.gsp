		...
		<div id="list-accountType" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="titleInt" title="${message(code: 'accountType.titleInt.label', default: 'Title Int')}" />
					
						<g:sortableColumn property="notes" title="${message(code: 'accountType.notes.label', default: 'Notes')}" />
					
						<g:sortableColumn property="recStatus" title="${message(code: 'accountType.recStatus.label', default: 'Rec Status')}" />
				...
				<g:each in="${accountTypeInstanceList}" status="i" var="accountTypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: accountTypeInstance, field: "titleInt")}</td>
					
						<td>${fieldValue(bean: accountTypeInstance, field: "notes")}</td>
					
						<td>${fieldValue(bean: accountTypeInstance, field: "recStatus")}</td>
			...
			<div class="pagination">
				<g:paginate total="${accountTypeInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
