		...
		<div id="list-riskLevel" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="recStatus" title="${message(code: 'riskLevel.recStatus.label', default: 'Rec Status')}" />
				...
				<g:each in="${riskLevelInstanceList}" status="i" var="riskLevelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: riskLevelInstance, field: "recStatus")}</td>
			...
			<div class="pagination">
				<g:paginate total="${riskLevelInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
