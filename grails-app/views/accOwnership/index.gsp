		...
		<div id="list-accOwnership" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="recStatus" title="${message(code: 'accOwnership.recStatus.label', default: 'Rec Status')}" />
				...
				<g:each in="${accOwnershipInstanceList}" status="i" var="accOwnershipInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: accOwnershipInstance, field: "recStatus")}</td>
			...
			<div class="pagination">
				<g:paginate total="${accOwnershipInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
