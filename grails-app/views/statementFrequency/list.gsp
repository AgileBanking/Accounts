	...
	<body>
		...
		<div id="list-statementFrequency" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdated" title="${message(code: 'statementFrequency.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${statementFrequencyInstanceList}" status="i" var="statementFrequencyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${statementFrequencyInstance.lastUpdated}" /></td>
			...
			<div class="pagination">
				<g:paginate total="${statementFrequencyInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
