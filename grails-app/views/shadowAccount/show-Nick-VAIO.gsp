		...
		<div id="show-shadowAccount" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					<g:hiddenField name="id" value="${shadowAccountInstance?.id}" />
					<g:link class="edit" action="edit" id="${shadowAccountInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
