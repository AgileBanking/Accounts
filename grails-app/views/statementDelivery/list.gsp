	...
	<body>
		...
		<div id="list-statementDelivery" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdated" title="${message(code: 'statementDelivery.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${statementDeliveryInstanceList}" status="i" var="statementDeliveryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${statementDeliveryInstance.lastUpdated}" /></td>
			...
			<div class="pagination">
				<g:paginate total="${statementDeliveryInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
